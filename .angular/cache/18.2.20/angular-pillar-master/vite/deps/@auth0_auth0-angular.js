...
function T(t2, i2) {
  return __async(this, null, function* () {
    ...
    const h2 = "urn:ietf:params:oauth:grant-type:token-exchange" === l2.grant_type, p2 = Object.assign(Object.assign(Object.assign({}, l2), h2 && a2 && {
      audience: a2
    }), h2 && r2 && {
      scope: r2
    }), g2 = d2 ? v(p2) : JSON.stringify(p2);
    return yield function(t3, i3, o3, n3, a3, r3, s2) {
      return __async(this, null, function* () {
        let c3, d3 = null;
        for (let e2 = 0; e2 < 3; e2++) try {
          c3 = yield O(t3, o3, n3, a3, r3, s2, i3), d3 = null;
          break;
        } catch (e3) {
          d3 = e3;
        }
        ...
        const l3 = c3.json, {
          error: h3,
          error_description: p3
        } = l3, g3 = e(l3, ["error", "error_description"]), {
          ok: w2
        } = c3;
        if (!w2) {
      ...
      body: g2,
      headers: {
        "Content-Type": d2 ? "application/x-www-form-urlencoded" : "application/json",
...
var te = class {
  ...
  loginWithRedirect() {
    return __async(this, arguments, function* (t2 = {}) {
      ...
      const o2 = Q(t2), {
        ...
        fragment: a2,
        appState: r2
      } = o2, s2 = e(o2, ["openUrl", "fragment", "appState"]), c2 = (null === (i2 = s2.authorizationParams) || void 0 === i2 ? void 0 : i2.organization) || this.options.authorizationParams.organization, u2 = yield this._prepareAuthorizeUrl(s2.authorizationParams || {}), {
        url: d2
      } = u2, l2 = e(u2, ["url"]);
  ...
  getTokenWithPopup() {
    return __async(this, arguments, function* (e2 = {}, t2 = {}) {
      ...
      return (yield this.cacheManager.get(new z({
        scope: o2.authorizationParams.scope,
        audience: o2.authorizationParams.audience || "default",
        clientId: this.options.clientId
      }))).access_token;
  ...
  _getTokenFromIFrame(e2) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const p2 = yield ((e3, t3, i4 = 60) => new Promise((o3, n3) => {
        ...
        const m2 = yield this._requestToken(Object.assign(Object.assign({}, e2.authorizationParams), {
          code_verifier: r2,
          code: p2.code,
          grant_type: "authorization_code",
          redirect_uri: s2,
  ...
  _getTokenUsingRefreshToken(e2) {
    return __async(this, null, function* () {
      const t2 = yield this.cacheManager.get(new z({
  ...
  _getIdTokenFromCache() {
    return __async(this, null, function* () {
      const e2 = this.options.authorizationParams.audience || "default", t2 = yield this.cacheManager.getIdToken(new z({
        clientId: this.options.clientId,
        audience: e2,
        scope: this.scope
  ...
  _getEntryFromCache(_0) {
    return __async(this, arguments, function* ({
      ...
      const o2 = yield this.cacheManager.get(new z({
        scope: e2,
        audience: t2,
        clientId: i2
      }), 60);
  ...
  exchangeToken(e2) {
    return __async(this, null, function* () {
      return this._requestToken({
        ...
        subject_token: e2.subject_token,
        subject_token_type: e2.subject_token_type,
        scope: j(e2.scope, this.scope),
        audience: e2.audience || this.options.authorizationParams.audience
      });
    });
  }
};
